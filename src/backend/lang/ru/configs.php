...
return [
    ...
    'handshake_logs_cleared' => 'Логи хендшейков очищены',
    'peer_traffic_reset' => 'Счётчики трафика пира сброшены',
    'config_traffic_reset' => 'Счётчики трафика всех пиров конфига сброшены',
];
