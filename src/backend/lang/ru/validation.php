...
return [
    ...
    */
    ...
    'any_of' => 'Значение поля :attribute отсутствует в списке разрешённых.',
    ...
    'present_with' => 'Значение поля :attribute должно быть, когда одно из :values присутствует.',
    ...
    'attributes' => [
        ...
        'vn_policy' => 'политика VN',
        'internal_subnet' => 'внутренняя подсеть',
        'listen_port' => 'порт прослушивания',
        'peer_dns' => 'DNS peer',
        'client_allowed_ips' => 'AllowedIPs клиента',
        'persistent_keepalive' => 'PersistentKeepalive',
        'server_address' => 'адрес сервера',
        'server_endpoint' => 'endpoint сервера',
        'panel_domain' => 'домен панели',
        'panel_port' => 'порт панели',
        'panel_https_port' => 'HTTPS-порт панели',
        'failure_webhook_url' => 'URL webhook',
        'endpoint_use_domain' => 'использовать домен в endpoint',
        'vpn_client_id' => 'клиент VPN',
        'use_preshared_key' => 'PresharedKey',
        'extra_allowed_ips' => 'дополнительные AllowedIPs',
        'excluded_client_ids' => 'исключённые клиенты',
        'exclusions_mutual' => 'взаимные исключения',
        'keepalive' => 'keepalive',
        'rules' => 'правила',
        'captcha_token' => 'токен капчи',
        'captcha_answer' => 'ответ капчи',
        'totp' => 'код 2FA',
        'renew' => 'обновить',
        'config_ids' => 'конфиги',
        'sync_interval_minutes' => 'интервал синхронизации',
        'ping_check_interval_min' => 'интервал ping-проверки',
        'refresh_subscription' => 'обновить подписку',
        'subscription_url' => 'URL подписки',
        'subscription_mode' => 'режим подписки',
        'subscription_selected' => 'выбранная локация',
        'awg_conf' => 'AWG-конфиг',
        'source_url' => 'URL источника',
        'domains' => 'домены',
        'cidrs' => 'подсети',
        'resolver_enabled' => 'резолвер включён',
        'resolver_reject_quic' => 'блокировать QUIC',
        'connection_id' => 'подключение',
        'resolver_dns' => 'DNS резолвера',
        'community_lists' => 'сообщественные списки',
        'user_domains' => 'пользовательские домены',
        'user_subnets' => 'пользовательские подсети',
    ],
