...
После привязки домена и выпуска сертификата Let's Encrypt в **Настройки → HTTPS** откройте панель по `https://` — её можно установить как PWA (кнопка **Установить приложение** в шапке или меню браузера «Установить» / «На экран Домой»).
