...
VPN-сервер AmneziaWG (версии протокола **1.0**, **1.5** и **2.0**, по умолчанию **2.0**) с Go API и админ-панелью на Quasar Vue. Все сервисы работают в Docker-контейнерах с префиксом `awggui`.
